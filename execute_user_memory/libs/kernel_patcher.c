...
int hijack_function(void *origin_f, void *hook_f, void **original_code_ptr, size_t *len_original_code)
{
	...
	jmp rax
	*/
	char shellcode[] = "\x90\x90\x90\x90\x49\xBF\xAB\x89\x67\x45\x23\x01\x00\x00\x41\xFF\xE7";
	
    /*
	mov r15, 0x123456789ab
	jmp r15
	*/
	char return_trampoline[] = "\x49\xBF\xAB\x89\x67\x45\x23\x01\x00\x00\x41\xFF\xE7";
